...
import "forge-tests/cash_manager/Minting.t.sol";
import "forge-tests/cash_manager/Redemption.t.sol";

contract TestCashManager_CashKYCSenderReceiver is
  TestCashMinting,
  TestCashRedemption
{
  function setUp() public {
    ...
    // Add KYC addresses
    address[] memory addressesToKYC = new address[](6);
