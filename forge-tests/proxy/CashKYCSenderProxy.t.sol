...
contract TestCashProxyKYCSenderSetup is BasicDeployment {
  function setUp() public {
    createDeploymentCashKYCSender();
    cashAdmin = cashKYCSenderProxyAdmin;
  }

  function test_unit_guradian_is_proxy_admin_owner() public {
    address adminOwner = cashKYCSenderProxyAdmin.owner();
  ...
  function test_unit_token_implementation_cannot_be_initialized() public {
    ...
    cashKYCSenderImpl.initialize("Test", "Case");
  }
